...
import ru.liga.packagesproject.services.truckLoadingStrategies.BalancedLoadingStrategy;
...
class BalancedLoadingStrategyTest {
    ...
    @BeforeEach
    void setUp() {
        balancedLoadingStrategy = new BalancedLoadingStrategy();
    }
    ...
    void testLoadPackagesSuccessfully() {
        ...
        List<Truck> trucks = balancedLoadingStrategy.loadPackages(packages, 1,6, 6);
    ...
    void testLoadPackagesMultipleTrucks() {
        ...
        List<Truck> trucks = balancedLoadingStrategy.loadPackages(packages, 2, 6, 6);
    ...
    void testLoadPackagesErrorWhenNotEnoughSpace() {
        ...
        assertThrows(RuntimeException.class, () -> balancedLoadingStrategy.loadPackages(packages, 1, 6, 6));
    }
