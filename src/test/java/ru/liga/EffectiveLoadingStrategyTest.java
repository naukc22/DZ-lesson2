...
import ru.liga.packagesproject.service.truckLoadingStrategy.EffectiveLoadingStrategy;
...
class EffectiveLoadingStrategyTest {
    ...
    @BeforeEach
    void setUp() {
        effectiveLoadingStrategy = new EffectiveLoadingStrategy(6, 6); // Размер трака 6x6
    }
    ...
    void testLoadPackagesSuccessfully() {
        ...
        List<Truck> trucks = effectiveLoadingStrategy.loadPackages(packages, 1);
    ...
    void testLoadPackagesMultipleTrucks() {
        ...
        List<Truck> trucks = effectiveLoadingStrategy.loadPackages(packages, 2);
    ...
    void testLoadPackagesErrorWhenNotEnoughSpace() {
        ...
        assertThrows(RuntimeException.class, () -> effectiveLoadingStrategy.loadPackages(packages, 1));
    }
